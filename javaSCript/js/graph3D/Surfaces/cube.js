Surfaces.prototype.cube = (x = 0, y = 0, z = 0, size = 10) => {
    return new Subject([
        ...
        new Polygon([0, 1, 2, 3], '#aa4455'), new Polygon([0, 4, 7, 3], '#772277'), new Polygon([0, 4, 5, 1], '#440077'),
        new Polygon([1, 2, 6, 5], '#ff7788'), new Polygon([2, 3, 7, 6], '#aa8899'), new Polygon([4, 5, 6, 7], '#8899ff')
    ]);
}
